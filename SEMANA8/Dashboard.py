...
def mostrar_menu():
    ...
    unidades = {
        '1': 'Unidad 2/POOSEMANA2.py',
        '2': 'Unidad 3/EJEMPLO-TRADICIONAL-SEMANA3.py'
        '3'  'Unidad 3/EJEMPLOS-DE-POO-SEMANA3.py'
        '4'  'Unidad 4/EJEMPLO_MUNDO_REAL_CARACTERISTICAS_POO.py'
        '5'  'Unidad 5/TIPOS-DE-DATOS-IDENTIFICADORES.py'
        '6'  'Unidad 6/CREAREMOS-UNA-CLASE-BASE-EMPLEADO-Y-UNA-CLASE-DERIBADA.py'
        '7'  'Unidad 7/COSTRUCTORE-Y-DESCONTRUTORES.py'
